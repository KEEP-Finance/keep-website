        ...
        <div className="slider-wrapper">
          <div className="slider-container">
            ...
            <div className="slide active" data-order="1" data-color="#EE4654">
              ...
              <canvas className="canvas" data-image="https://s3-us-west-2.amazonaws.com/s.cdpn.io/42764/mask-karlie.jpg"></canvas>
            ...
            >
              ...
              <canvas className="canvas" data-image="https://s3-us-west-2.amazonaws.com/s.cdpn.io/42764/mask-aline.jpg"></canvas>
              <div className="slide-content ">
